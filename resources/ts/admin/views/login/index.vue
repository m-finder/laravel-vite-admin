...
import logoMini from '@admin/assets/logo-mini.svg';
import loginIconTwo from '@admin/assets/login-icon-two.svg';
...
import Scan from '@admin/views/login/component/scan.vue';
